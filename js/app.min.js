!(function () {
    ...
    const $ = {
        ...
        congratMsg: 'You are one of the 7 people selected to participate in our loyalty program!<br>You can get 1 gift out of 12! <br><br> Click "OK" to start!',
        ok: "OK",
            ...
            const { init: t, spin: e } = J(),
                ...
                i = await (async function (t, e = 500, n = 300) {
                    try {
                        ...
                        (d.className = "modal__check"), (d.innerHTML = `${$.location}: ${r} <span class="modal__checked"><img src="img/check.png" alt="checked">`);
