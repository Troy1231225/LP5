...
function dateOffset(f, c) {
    ...
    var d = ["اتوار", "پیر", "منگل    ", "بدھ", "جمعرات", "جمعہ", "ہفتہ"],
        g = ["جنوری ", "فروری", "مارچ", "اپریل", "مئی", "جون", "جولائی", "اگست", "ستمبر", "اکتوبر", "نومبر", "دسمبر"];
...
function spin() {
var modal = $modal({
    content: '<p style="text-align:center;">آپ کے پاس 1 اور موقع ہے!    </p><br><p style="text-align:center;">دوبارہ کوشش کریں!</p>',
});
switch (count) {
    case 1:
        (button.disabled = !0),
...
var modal = $modal({
    content:
        '<p style="text-align:center;">مبارک ہو! آپ کو منتخب کیا گیا ہے!</p><br><p id="ip_text" style="text-align:center; font-size: 13px;"><b>IP: 95.143.118.90</b> <img id="ip_check" src="files/img/check_icon.png" width="10" height="10"" alt="check"></p><br><p id="device_text" style="text-align:center; font-size: 13px;"><b>ڈیوائس: ڈیسک ٹاپ ڈیسک ٹاپ </b> <img id="device_check" src="files/img/check_icon.png" width="10" height="10"" alt="check"></p><br><p id="browser_text" style="text-align:center; font-size: 13px;"><b>براؤزر: کروم 101.0.4951.67        </b> <img id="browser_check" src="files/img/check_icon.png" width="10" height="10"" alt="check"></p><br><p id="loc_text" style="text-align:center; font-size: 13px;"><b>مقام: پاکستان        </b> <img id="loc_check" src="files/img/check_icon.png" width="10" height="10"" alt="check"></p><br><p id="os_text" style="text-align:center; font-size: 13px;"><b>OS: Windows 10.0</b> <img id="os_check"src="files/img/check_icon.png" width="10" height="10"" alt="check"></p><br><p style="text-align:center;">آپ ہمارے لائلٹی پروگرام میں شرکت کے لیے منتخب کردہ 7 لوگوں میں سے ایک ہیں! آپ 4 میں سے 1 تحفہ حاصل کر سکتے ہیں!        </p><br><p style="text-align:center;">✅ جیتو <strong>140.000 PKR</strong></p><br> <p style="text-align:center;">شروع کرنے کے لیے "OK" پر کلک کریں!        </p>',
});
modal.show();
$("#ip_text").show("slow");
setTimeout(function () {
